...
<html lang="en">
  ...
  <img src="speak.png" ,alt="Image not Found" style="
  position:absolute;
  ...
  <li class="nav-item">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="#">Speakers<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
...
if(isset($_POST['submit'])){
  $Id=$_POST['Id'];
  $insert=true;
  $sq = "SELECT * FROM `speakers` WHERE ID= '$Id' ";
  ...
  $sqw="UPDATE `speakers` SET `Stock`=$ston-1 WHERE ID='$idn'";
